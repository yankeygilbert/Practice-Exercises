...
class HealthAnalyzer:
    ...
    def Search(self,Sname=" "):
        ...
        for index in range(0,len(Patientdb)):
            ...
            if (self.searchlastname ) == Patientdb[index]['last_name']:
    ...
    def startProgram(self):
            ...
            if self.value == 1:
                Patient.userinfo()
                print()
                Patient.healthAnalysis()
                
                
            if self.value == 2:
                self.searchname = input("Enter Patient lastname \n")
                Patient.Search(self.searchname)
...
#lsit for paitentreocrds
Patientdb = []
Patient = HealthAnalyzer()
Patient.startProgram()
